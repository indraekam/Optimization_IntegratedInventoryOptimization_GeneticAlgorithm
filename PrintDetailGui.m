function [jtecb, jtecv, totalFitnes] = PrintDetailGui(arrIndividu, batikDemand, margariaDemand, fendiDemand, batikCost, margariaCost, fendiCost)
    varS = 661149;
    varDt = batikDemand + margariaDemand + fendiDemand;
    varHv = 71196;
    varP = 1318;
    varG = 262213;
    varT = 0.06;
