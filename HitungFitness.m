function arrFitness = HitungFitness(populasi, arrIndividu)
...
for x = 1 : populasi
    ...
    % Var Hitung JTXCB
    varD = [336, 317, 206]; % 1. BKR, 2. MGB, 3.FRB
    varA = [600000,600000,400000]; % 1. BKR, 2. MGB, 3.FRB
    varPhi = [238719, 238719, 238719]; % 1. BKR, 2. MGB, 3.FRB
    varBeta = [0.25, 0.25, 0.3];% 1. BKR, 2. MGB, 3.FRB
    varPhiNol = [990000, 495000, 825000];% 1. BKR, 2. MGB, 3.FRB
    varSimpanganBaku = [2.658, 1.007, 0.9055]; % 1. BKR, 2. MGB, 3.FRB
